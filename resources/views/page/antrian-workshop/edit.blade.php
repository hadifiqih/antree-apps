...
<div class="container-fluid">
    ...
    <div class="mb-3">
        ...
        @php
            ...
            $isCheckedGresik = is_array($tempat) && in_array('Gresik', $tempat);
        @endphp
        <div class="col-sm">
            <div class="form-check">
        ...
        <div class="col-sm">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="gresik" name="tempat[]" value="Gresik" {{ $isCheckedGresik ? 'checked' : '' }}>
                <label for="gresik" class="form-check-label">Gresik</label>
            </div>
        </div>
    </div>
