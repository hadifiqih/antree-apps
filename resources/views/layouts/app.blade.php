        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                    <a href="https://antrian.pakarstempel.com/pos/add-order" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Order Retail</p>
                    </a>
                </li>
                ...
                @if(auth()->user()->role == 'admin' || auth()->user()->id == 48 || auth()->user()->id == 55 || auth()->user()->id == 16 || auth()->user()->id == 51)
                ...
                @endif
                <li class="nav-item">
                  <a href="{{ route('antrian.searchByTicket') }}" class="nav-link {{ request()->routeIs('antrian.searchByTicket') ? 'active' : '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Cari Order <span class="right badge badge-danger">New</span></p>
                  </a>
                </li>
            </ul>
          </li>
